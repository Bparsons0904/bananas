...
function App() {
  ...
  const [selectedOrm, setSelectedOrm] = useState(orms[0])
      ...
      <div className="controls">
        <div className="control-group">
          ...
          <select
            ...
            onChange={(e) => setSelectedFramework(frameworks.find(f => f.value === e.target.value)!)}
          >
            {frameworks.map(fw => (
        ...
        <div className="control-group">
          ...
          <select
            ...
            onChange={(e) => setSelectedOrm(orms.find(o => o.value === e.target.value)!)}
          >
            {orms.map(orm => (
        ...
        <div className="control-group">
          ...
          <select
            ...
            onChange={(e) => setSelectedEndpoint(endpoints.find(ep => ep.path === e.target.value)!)}
          >
            {endpoints.map(ep => (
        ...
        <button onClick={runTest} disabled={loading} className="test-button">
